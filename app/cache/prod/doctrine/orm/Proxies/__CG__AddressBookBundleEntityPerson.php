...
class Person extends \AddressBookBundle\Entity\Person implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'id', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'name', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'surname', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'description', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'phones', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'emails', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'addresses', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'user', '' . "\0" . 'AddressBookBundle\\Entity\\Person' . "\0" . 'ranks');
        }
    ...
    public function addRank(\AddressBookBundle\Entity\Rank $ranks)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRank', array($ranks));
    ...
    public function removeRank(\AddressBookBundle\Entity\Rank $ranks)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRank', array($ranks));
