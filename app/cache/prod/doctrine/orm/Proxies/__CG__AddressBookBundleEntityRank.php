 ...
 */
class Rank extends \AddressBookBundle\Entity\Rank implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AddressBookBundle\\Entity\\Rank' . "\0" . 'id', '' . "\0" . 'AddressBookBundle\\Entity\\Rank' . "\0" . 'name', '' . "\0" . 'AddressBookBundle\\Entity\\Rank' . "\0" . 'userId', '' . "\0" . 'AddressBookBundle\\Entity\\Rank' . "\0" . 'persons');
        }
